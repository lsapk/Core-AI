                ...
                >
                  ...
                  <View style={styles.mealInfo}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      {meal.mealType && (
                         <Text style={styles.mealTypeText}>{getMealTypeIcon(meal.mealType)}</Text>
                      )}
                      {meal.servings > 0 && (
...
const getStyles = (theme: ReturnType<typeof useAppTheme>) => StyleSheet.create({
  ...
  mealTypeText: { fontSize: 11, fontWeight: '600', color: theme.colors.secondaryText, marginRight: 6 },

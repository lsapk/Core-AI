...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Alert, Switch, Dimensions, Modal, Platform } from 'react-native';
    ...
    >
      ...
      <Modal visible={showPrivacy} animationType="slide" presentationStyle="pageSheet">
        <View style={styles.modalContainer}>
          <View style={[styles.modalHeader, { paddingTop: Platform.OS === 'ios' ? 10 : insets.top }]}>
